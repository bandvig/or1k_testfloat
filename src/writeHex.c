...
void writeHex_flag( flag a )
{
  putchar( a ? '1' : '0' );
}


static void writeHex_bits8( bits8 a )
{
  /*
  int digit;
...
static void writeHex_bits12( int16 a )
{
  /*
  int digit;
...
static void writeHex_bits16( bits16 a )
{
  /*
  int digit;
...
void writeHex_bits32( bits32 a )
{
  //writeHex_bits16( a>>16 );
  //writeHex_bits16( a );
  printf("%08X",a);
  //or1k_report(a); // NewLIB 2.4.0+
}


#ifdef BITS64
void writeHex_bits64( bits64 a )
{
...
void writeHex_float32( float32 a )
{
...
#ifdef BITS64
void writeHex_float64( float64 a )
{
...
#ifdef FLOATX80
void writeHex_floatx80( floatx80 a )
{
...
#ifdef FLOAT128
void writeHex_float128( float128 a )
{
...
void writeHex_float_flags( uint8 flags )
{
